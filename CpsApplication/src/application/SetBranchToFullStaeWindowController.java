...
public class SetBranchToFullStaeWindowController implements Initializable {

    @FXML // fx:id="btn_Cancel"
    private Button btn_Cancel; // Value injected by FXMLLoader

    @FXML // fx:id="btn_SendReport"
    private Button btn_SendReport; // Value injected by FXMLLoader
    ...
    void SendReport_Click(ActionEvent event) {
    	try {
			...
			sqlClient.setBranchToFullState(name, requestToken);
